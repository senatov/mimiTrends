...
class AdaptiveResultSelectorTest {
    @Test
    fun `adds at most two preferred adaptive candidates before the watch tier`() {
    ...
    @Test
    fun `never publishes more than fifteen rows`() {
    ...
    @Test
    fun `does not fill the target with weak adaptive candidates`() {
        val strict = listOf(result("STRICT", 8.0))
    ...
    @Test
    fun `does not relabel additional qualified trends as watch candidates`() {
    ...
    @Test
    fun `does not fill the list by converting weaker trends to watch candidates`() {
        val strict = listOf(result("STRICT", 8.0))
    ...
    @Test
    fun `can fill the list with candidates already classified as watch`() {
        val strict = listOf(result("STRICT", 8.0))
        val watch = (1..10).map { index ->
    ...
    @Test
    fun `fills quiet markets with the best long term rises`() {
    ...
    @Test
    fun `fills a quiet market with explicitly labelled neutral contexts`() {
