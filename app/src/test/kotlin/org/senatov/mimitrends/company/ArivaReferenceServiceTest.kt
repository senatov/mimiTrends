...
class ArivaReferenceServiceTest {
    @Test
    fun `adds bounded minute and second jitter to the half hour interval`() {
    ...
    @Test
    fun `persists an ARIVA reference only after verifying the selected isin`() {
    ...
    @Test
    fun `ignores symbol replacement after close`() {
