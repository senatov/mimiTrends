...
class MultiHorizonTrendModelTest {
    @Test
    fun `stable multi-month rise scores above a choppy path`() {
    ...
    @Test
    fun `persistent decline is rejected despite a late bounce`() {
    ...
    @Test
    fun `short history produces limited confidence without inventing long horizons`() {
    ...
    @Test
    fun `one additional session does not make a stable trend score jump`() {
