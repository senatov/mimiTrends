...
class FeedAgeTest {
    @Test
    fun `reports completed minutes without overstating feed delay`() {
    ...
    @Test
    fun `accepts a feed within its declared delay and grace period`() {
        val now = 2_200_000L
    ...
    @Test
    fun `marks a feed stale beyond its declared delay and grace period`() {
        val now = 2_260_000L
    ...
    @Test
    fun `shows an hourglass while focused data is refreshing`() {
