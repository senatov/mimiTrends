...
class ResearchReportCsvTest {
    @Test
    fun `exports stable locale independent research rows`() {
        ...
        assertEquals(
            "10,0.20000000,\"Impulse, strict\",down,12,4,0.55000000,0.50000000,0.24750000,-0.12500000",
            lines.last()
        )
    }

    @Test
    fun `exports headers when report has no evaluated metrics`() {
