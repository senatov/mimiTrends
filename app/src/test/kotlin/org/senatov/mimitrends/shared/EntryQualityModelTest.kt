...
class EntryQualityModelTest {
    @Test
    fun `calm pullback with tight spread has good entry quality`() {
        val assessment = EntryQualityModel.assess(
            input(
    ...
    @Test
    fun `accelerating purchase near high triggers pullback cooldown`() {
        val assessment = EntryQualityModel.assess(
            input(
    ...
    @Test
    fun `missing quote lowers confidence without inventing a spread`() {
        val assessment = EntryQualityModel.assess(
            input(
