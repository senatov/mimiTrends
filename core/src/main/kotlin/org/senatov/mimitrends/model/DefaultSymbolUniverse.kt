...
object DefaultSymbolUniverse {
    val symbols: List<String> = listOf(
        ...
        "MMC", "ETN", "LRCX", "CB", "ADI", "PGR", "MU", "BSX",
        "KLAC", "FI", "ELV", "REGN", "CME", "SO", "DUK", "MO",
        ...
        "COIN", "PLTR", "SHOP", "SOFI", "SNAP", "INTC", "SQ", "CRWD",
        ...
        "NOKIA.HE", "KNEBV.HE", "FORTUM.HE", "UPM.HE", "NESTE.HE", "SAMPO.HE", "WRT1V.HE", "METSO.HE"
    )
}
