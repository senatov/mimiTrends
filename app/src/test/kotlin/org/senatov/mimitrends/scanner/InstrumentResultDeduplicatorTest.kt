...
class InstrumentResultDeduplicatorTest {
    @Test
    fun `keeps the strongest listing when isin is shared`() {
    ...
    @Test
    fun `uses normalized company name when isin is unavailable`() {
    ...
    @Test
    fun `does not merge equal names when known isins conflict`() {
    ...
    @Test
    fun `removes transaction-taxed results loaded from history`() {
