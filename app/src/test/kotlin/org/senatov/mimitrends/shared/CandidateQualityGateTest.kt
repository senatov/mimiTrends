...
class CandidateQualityGateTest {
    @Test
    fun `rejects low turnover and wide executable spreads`() {
    ...
    @Test
    fun `rejects an impulse without volume unless price evidence is exceptional`() {
    ...
    @Test
    fun `requires a mature efficient trend`() {
    ...
    @Test
    fun `requires the eightieth percentile for a calibrated adaptive signal`() {
    ...
    @Test
    fun `rejects cooling and old signals`() {
        assertFalse(
            CandidateQualityGate.qualifies(
    ...
    @Test
    fun `places a sharp downside watch after a long candidate`() {
    ...
    @Test
    fun `accepts a weaker current trend only for the watch tier`() {
    ...
    @Test
    fun `accepts an early recovery only for the watch tier`() {
    ...
    @Test
    fun `does not present an extended trend as an active entry`() {
    ...
    @Test
    fun `accepts a qualified two session trend as long term`() {
    ...
    @Test
    fun `accepts an exceptional decline only in the watch tier`() {
        val result = TestScanResult.create(
