...
internal class SignalInspectorPanel : VBox(10.0) {
    ...
    private fun section(caption: String, value: Label) = VBox(
        5.0,
        Label(caption).apply { styleClass += "inspector-section-caption" }, value
    ).apply { styleClass += "inspector-section" }

    private fun valueLabel() = Label("Quote, analysis, and evaluation times will appear here.")
        .also(::configureValueLabel)
